...
try:
    ...
    # チャート設定
    ax1.set_title(f'{ticker} Daily Chart (1 Year) - Data as of {today_str} JST', fontsize=16, fontweight='bold')
    ...
    # チャートを保存
    chart_filename = f'tsla_chart_{today_str}.png'
    plt.savefig(chart_filename, dpi=150, bbox_inches='tight')
    print(f"\nチャートを保存しました: {chart_filename}")
