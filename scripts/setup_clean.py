...
def main():
    ...
    parser = argparse.ArgumentParser(description='TIKER プロジェクト初期化・クリーンアップ')
    parser.add_argument('--clean-all', action='store_true', help='古いファイルを全てクリーンアップ')
    parser.add_argument('--demo', action='store_true', help='デモ実行')
    parser.add_argument('--structure', action='store_true', help='プロジェクト構造を表示')
